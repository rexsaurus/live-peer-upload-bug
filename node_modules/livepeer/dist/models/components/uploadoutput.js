 ...
 */
var UploadOutput = /** @class */ (function (_super) {
    __extends(UploadOutput, _super);
    ...
    ], UploadOutput.prototype, "url", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], UploadOutput.prototype, "encryption", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "recordedSessionId" }),
        __metadata("design:type", String)
    ], UploadOutput.prototype, "recordedSessionId", void 0);
    return UploadOutput;
