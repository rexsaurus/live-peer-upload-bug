...
var Task = /** @class */ (function () {
    function Task(sdkConfig) {
        this.sdkConfiguration = sdkConfig;
    }
    /**
     * Retrieve Tasks
     */
    Task.prototype.getAll = function (config) {
        var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        operationUrl = baseURL.replace(/\/$/, "") + "/task";
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    ...
                                    res.data = utils.objectToClass(JSON.parse(decodedRes), components.Task, resFieldDepth);
                                }
                                else {
     ...
     * Retrieve a Task
     */
    Task.prototype.get = function (taskId, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.GetTaskRequest({
                            taskId: taskId,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/task/{taskId}", req);
                        client = this.sdkConfiguration.defaultClient;
                        globalSecurity = this.sdkConfiguration.security;
                        if (!(typeof globalSecurity === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalSecurity()];
                    ...
                    case 3:
                        ...
                        res = new operations.GetTaskResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
