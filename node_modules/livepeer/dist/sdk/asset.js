...
var Asset = /** @class */ (function () {
    function Asset(sdkConfig) {
        this.sdkConfiguration = sdkConfig;
    }
    /**
     * Retrieve assets
     */
    Asset.prototype.getAll = function (config) {
        var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        operationUrl = baseURL.replace(/\/$/, "") + "/asset";
                    ...
                    case 3:
                        ...
                        res = new operations.GetAssetsResponse({
     ...
     * Upload an asset
     */
    Asset.prototype.create = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/asset/request-upload";
                    ...
                    case 3:
                        ...
                        res = new operations.RequestUploadResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.data = utils.objectToClass(JSON.parse(decodedRes), operations.RequestUploadData);
                                }
                                else {
                                    throw new errors.SDKError("unknown content-type received: " + responseContentType, httpRes.status, decodedRes, httpRes);
                                }
     ...
     */
    Asset.prototype.createViaURL = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, _c, reqBodyHeaders, reqBody, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/asset/upload/url";
                        _c = __read([{}, null], 2), reqBodyHeaders = _c[0], reqBody = _c[1];
                        try {
                            _d = __read(utils.serializeRequestBody(req, "request", "json"), 2), reqBodyHeaders = _d[0], reqBody = _d[1];
                        }
                    ...
                    case 3:
                        ...
                        res = new operations.UploadAssetViaURLResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.data = utils.objectToClass(JSON.parse(decodedRes), operations.UploadAssetViaURLData);
                                }
                                else {
                                    throw new errors.SDKError("unknown content-type received: " + responseContentType, httpRes.status, decodedRes, httpRes);
                                }
     ...
     * Delete an asset
     */
    Asset.prototype.delete = function (assetId, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.DeleteAssetRequest({
                            assetId: assetId,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/asset/{assetId}", req);
                        client = this.sdkConfiguration.defaultClient;
                        globalSecurity = this.sdkConfiguration.security;
                        if (!(typeof globalSecurity === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalSecurity()];
                    ...
                    case 3:
                        ...
                        res = new operations.DeleteAssetResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     * Retrieves an asset
     */
    Asset.prototype.get = function (assetId, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.GetAssetRequest({
                            assetId: assetId,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/asset/{assetId}", req);
                    ...
                    case 3:
                        ...
                        res = new operations.GetAssetResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     * Update an asset
     */
    Asset.prototype.update = function (assetId, assetPatchPayload, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        req = new operations.PatchAssetAssetIdRequest({
                            assetId: assetId,
                        ...
                        _c = __read([{}, null], 2), reqBodyHeaders = _c[0], reqBody = _c[1];
                        try {
                            _d = __read(utils.serializeRequestBody(req, "assetPatchPayload", "json"), 2), reqBodyHeaders = _d[0], reqBody = _d[1];
                        }
                        catch (e) {
                            if (e instanceof Error) {
                                throw new Error("Error serializing request body, cause: ".concat(e.message));
                    ...
                    case 3:
                        ...
                        res = new operations.PatchAssetAssetIdResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
