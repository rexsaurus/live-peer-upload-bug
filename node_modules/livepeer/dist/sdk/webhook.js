...
var Webhook = /** @class */ (function () {
     ...
     * Retrieve a Webhook
     */
    Webhook.prototype.getAll = function (config) {
        var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        operationUrl = baseURL.replace(/\/$/, "") + "/webhook";
                    ...
                    case 3:
                        ...
                        res = new operations.GetWebhooksResponse({
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    ...
                                    res.data = utils.objectToClass(JSON.parse(decodedRes), components.Webhook, resFieldDepth);
                                }
                                else {
     ...
     * Create a webhook
     */
    Webhook.prototype.create = function (config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        res = new operations.CreateWebhookResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     * Delete a webhook
     */
    Webhook.prototype.delete = function (id, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.DeleteWebhookRequest({
                            id: id,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/webhook/{id}", req);
                        client = this.sdkConfiguration.defaultClient;
                        globalSecurity = this.sdkConfiguration.security;
                        if (!(typeof globalSecurity === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalSecurity()];
                    ...
                    case 3:
                        ...
                        res = new operations.DeleteWebhookResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     * Retrieve a webhook
     */
    Webhook.prototype.get = function (id, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var req, baseURL, operationUrl, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.GetWebhookRequest({
                            id: id,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/webhook/{id}", req);
                    ...
                    case 3:
                        ...
                        res = new operations.GetWebhookResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     * Update a webhook
     */
    Webhook.prototype.update = function (id, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var req, baseURL, operationUrl, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.UpdateWebhookRequest({
                            id: id,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/webhook/{id}", req);
                    ...
                    case 2:
                        ...
                        headers["Accept"] = "application/json";
                        headers["user-agent"] = this.sdkConfiguration.userAgent;
                        return [4 /*yield*/, client.request(__assign({ validateStatus: function () { return true; }, url: operationUrl, method: "put", headers: headers, responseType: "arraybuffer" }, config))];
                    case 3:
                        httpRes = _c.sent();
                        responseContentType = (_b = (_a = httpRes === null || httpRes === void 0 ? void 0 : httpRes.headers) === null || _a === void 0 ? void 0 : _a["content-type"]) !== null && _b !== void 0 ? _b : "";
                        if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null) {
                        ...
                        res = new operations.UpdateWebhookResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
