...
var AccessControl = /** @class */ (function () {
    function AccessControl(sdkConfig) {
        this.sdkConfiguration = sdkConfig;
    }
    /**
     * Retrieves signing keys
     */
    AccessControl.prototype.getSigningKeys = function (config) {
        var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        operationUrl = baseURL.replace(/\/$/, "") + "/access-control/signing-key";
                    ...
                    case 3:
                        ...
                        res = new operations.GetSigningKeysResponse({
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    ...
                                    res.data = utils.objectToClass(JSON.parse(decodedRes), components.SigningKey, resFieldDepth);
                                }
                                else {
     ...
     */
    AccessControl.prototype.createSigningKey = function (config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        res = new operations.CreateSigningKeyResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.signingKeyResponsePayload = utils.objectToClass(JSON.parse(decodedRes), components.SigningKeyResponsePayload);
                                }
                                else {
                                    throw new errors.SDKError("unknown content-type received: " + responseContentType, httpRes.status, decodedRes, httpRes);
                                }
     ...
     * Delete Signing Key
     */
    AccessControl.prototype.deleteSigningKey = function (keyId, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.DeleteSigningKeyRequest({
                            keyId: keyId,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/access-control/signing-key/{keyId}", req);
                        client = this.sdkConfiguration.defaultClient;
                        globalSecurity = this.sdkConfiguration.security;
                        if (!(typeof globalSecurity === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalSecurity()];
                    ...
                    case 3:
                        ...
                        res = new operations.DeleteSigningKeyResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     */
    AccessControl.prototype.getSigningKey = function (keyId, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.GetSigningKeyRequest({
                            keyId: keyId,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/access-control/signing-key/{keyId}", req);
                    ...
                    case 3:
                        ...
                        res = new operations.GetSigningKeyResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.signingKey = utils.objectToClass(JSON.parse(decodedRes), components.SigningKey);
                                }
                                else {
                                    throw new errors.SDKError("unknown content-type received: " + responseContentType, httpRes.status, decodedRes, httpRes);
                                }
     ...
     */
    AccessControl.prototype.updateSigningKey = function (keyId, requestBody, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        req = new operations.UpdateSigningKeyRequest({
                            keyId: keyId,
                    ...
                    case 3:
                        ...
                        res = new operations.UpdateSigningKeyResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
