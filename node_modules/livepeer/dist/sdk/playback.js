...
var Playback = /** @class */ (function () {
    function Playback(sdkConfig) {
        this.sdkConfiguration = sdkConfig;
    }
    /**
     * Retrieve Playback Info
     */
    Playback.prototype.get = function (id, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var req, baseURL, operationUrl, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes, err;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        req = new operations.GetPlaybackInfoRequest({
                            id: id,
                        });
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = utils.generateURL(baseURL, "/playback/{id}", req);
                    ...
                    case 3:
                        ...
                        res = new operations.GetPlaybackInfoResponse({
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.playbackInfo = utils.objectToClass(JSON.parse(decodedRes), components.PlaybackInfo);
                                }
                                else {
                            ...
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 404:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    err = utils.objectToClass(JSON.parse(decodedRes), errors.ErrorT);
